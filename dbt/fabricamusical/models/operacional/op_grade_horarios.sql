...
STRING_AGG(if(a.sala = 'Sala 1', concat(p.apelido, ' - ', aluno,if(a.tipo != 'REG', concat(' - ', a.tipo, ': ', data), '')), null), ' | ') as sala1,
STRING_AGG(if(a.sala = 'Sala 2', concat(p.apelido, ' - ', aluno,if(a.tipo != 'REG', concat(' - ', a.tipo, ': ', data), '')), null), ' | ') as sala2,
STRING_AGG(if(a.sala = 'Sala 3', concat(p.apelido, ' - ', aluno,if(a.tipo != 'REG', concat(' - ', a.tipo, ': ', data), '')), null), ' | ') as sala3,
STRING_AGG(if(a.sala = 'Sala 4', concat(p.apelido, ' - ', aluno,if(a.tipo != 'REG', concat(' - ', a.tipo, ': ', data), '')), null), ' | ') as sala4,
STRING_AGG(if(a.sala = 'Sala 5', concat(p.apelido, ' - ', aluno,if(a.tipo != 'REG', concat(' - ', a.tipo, ': ', data), '')), null), ' | ') as sala5,
STRING_AGG(if(a.sala = 'Sala 6', concat(p.apelido, ' - ', aluno,if(a.tipo != 'REG', concat(' - ', a.tipo, ': ', data), '')), null), ' | ') as sala6,
STRING_AGG(if(a.sala = 'Sala 7', concat(p.apelido, ' - ', aluno,if(a.tipo != 'REG', concat(' - ', a.tipo, ': ', data), '')), null), ' | ') as sala7,
STRING_AGG(if(a.sala = 'Sala 8', concat(p.apelido, ' - ', aluno,if(a.tipo != 'REG', concat(' - ', a.tipo, ': ', data), '')), null), ' | ') as sala8,
STRING_AGG(if(a.sala = 'Sala 9', concat(p.apelido, ' - ', aluno,if(a.tipo != 'REG', concat(' - ', a.tipo, ': ', data), '')), null), ' | ') as sala9
